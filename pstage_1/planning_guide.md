...
<p align="center">
  <img src="/images/image-20210903185917011.png" width="50%">
</p>
...
또한 최종 모델에서 TTA를 적용할 때 augmentation 기법들에 대한 조합별로 스코어를 기록했으며 최적의 augmentation을 찾아냈다는 것이 성능향상에 유의미하게 작용하였습니다. 저희는 TTA를 적용했을 때 최대 0.746 -> 0.763 까지 0.017 정도의 f1 스코어 향상을 보았고, Evaluation 대회에서는 꽤 적절한 기법이었다고 생각합니다.
